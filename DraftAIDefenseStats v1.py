...
if not os.path.exists('defensivestats'):
    os.makedirs('defensivestats')
...
def calculate_seasonal_defensive_stats_with_points_allowed_and_buckets(year):
    ...
    weekly_file_path = f'defensivestats/weekly_defensive_stats_{year}.csv'
    weekly_defensive_stats.to_csv(weekly_file_path, index=False)
    seasonal_file_path = f'defensivestats/seasonal_defensive_stats_{year}.csv'
